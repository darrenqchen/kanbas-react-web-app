  ...
  return (
    <div className="container" id="wd-lab2">
      ...
      wd-border-red wd-border-solid wd-bg-color-yellow">
        ...
        <div
          className="wd-padded-bottom-right wd-border-fat wd-border-blue wd-border-solid 
      wd-bg-color-yellow">
          Padded bottom right
        </div>

        <div
          className="wd-padding-fat wd-border-fat wd-border-yellow wd-border-solid 
      ...
      wd-padded-bottom-right wd-border-fat wd-border-blue 
